...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Agu 2025 pada 19.03
...
-- Event
--
CREATE EVENT `auto_reject_kemajuan_awal` ON SCHEDULE EVERY 10 MINUTE STARTS '2025-08-10 01:57:35' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE laporan_kemajuan_awal lk
...
CREATE EVENT `auto_reject_kemajuan_bertumbuh` ON SCHEDULE EVERY 10 MINUTE STARTS '2025-08-10 01:57:35' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE laporan_kemajuan_bertumbuh lk
  JOIN (SELECT kemajuan_selesai FROM pengaturan_jadwal ORDER BY id DESC LIMIT 1) j
    ON 1=1
  SET lk.status = 'ditolak'
  WHERE lk.status IN ('draf','diajukan','revisi')
...
CREATE EVENT `auto_reject_file_kemajuan` ON SCHEDULE EVERY 10 MINUTE STARTS '2025-08-10 02:49:02' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE file_laporan_kemajuan flk
  JOIN (SELECT kemajuan_selesai FROM pengaturan_jadwal ORDER BY id DESC LIMIT 1) j
    ON 1=1
...
CREATE EVENT `auto_reject_akhir_awal` ON SCHEDULE EVERY 10 MINUTE STARTS '2025-08-10 02:49:17' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE laporan_akhir_awal la
...
CREATE EVENT `auto_reject_akhir_bertumbuh` ON SCHEDULE EVERY 10 MINUTE STARTS '2025-08-10 02:49:17' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE laporan_akhir_bertumbuh la
  JOIN (SELECT akhir_selesai FROM pengaturan_jadwal ORDER BY id DESC LIMIT 1) j
    ON 1=1
  SET la.status = 'ditolak'
  WHERE la.status IN ('draf','diajukan','revisi')
...
CREATE EVENT `auto_reject_file_akhir` ON SCHEDULE EVERY 10 MINUTE STARTS '2025-08-10 02:49:17' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE file_laporan_akhir fla
  JOIN (SELECT akhir_selesai FROM pengaturan_jadwal ORDER BY id DESC LIMIT 1) j
    ON 1=1
